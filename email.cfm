...
<div id="main" style="float:left;">
    ...
    <div style="width:300px;margin-right:30px;float:left;">
        <img align="none" alt="GallatinCover" border="0" hspace="0" src="https://d77151eeba-custmedia.vresp.com/56c79dbf7c/GallatinCover.jpg" style="width: 300px; height: 388px;" title="GallatinCover" vspace="0" />
    </div>
            ...
            <div style='background-color:#006;border-color:white;border-width:3px;width:300px;height:120px;'>
                <div style='padding:8px;'>
                    ...
                    <div style='float:left;'>
                        <div style='color:#FFF;font-family:"Times New Roman";float:left;width:30px;text-align:right;font-weight:bold;clear:both;'>Name</div>
                        ...
                        <div style='color:#FFF;font-family:"Times New Roman";float:left;width:30px;text-align:right;font-weight:bold;clear:both;'>Email</div>
                        ...
                        <div style='color:#FFF;font-family:"Times New Roman";float:left;width:30px;text-align:right;font-weight:bold;clear:both;'>&nbsp;</div>
